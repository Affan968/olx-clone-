                    ...
                    <div className="w-8">
                        {step > 1 && (
                            <button
                                ...
                                className="text-[#002f34] hover:bg-gray-100 p-1.5 rounded-full transition cursor-pointer"
                            >
                ...
                <div className="flex-grow overflow-y-scroll px-10 custom-olx-scrollbar">
                    ...
                    {step === 1 && (
                        <div className="flex flex-col animate-in fade-in duration-300">
                            ...
                            <h2 className="text-center text-[24px] font-bold text-[#002f34] mb-8 leading-tight">
                            ...
                            <div className="space-y-3">
                                <button className="w-full flex items-center border-[1px] border-[#002f34] py-3 px-5 rounded-md font-bold text-[#002f34] bg-white cursor-pointer hover:bg-gray-50 hover:ring-[2px] hover:ring-[#002f34] transition-all">
                                    ...
                                    <span className="flex-grow text-center text-[16px]">Join with Google</span>
                                </button>

                                <button className="w-full flex items-center border-[1px] border-[#002f34] py-3 px-5 rounded-md font-bold text-[#002f34] bg-white cursor-pointer hover:bg-gray-50 hover:ring-[2px] hover:ring-[#002f34] transition-all">
                                    <img src="https://www.svgrepo.com/show/475647/facebook-color.svg" className="h-6 w-6 rounded-xl" alt="Facebook" />
                                    <span className="flex-grow text-center text-[16px]">Join with Facebook</span>
                                </button>

                                <div className="flex items-center gap-2 my-5">
                                    <div className="flex-grow h-[1px] bg-gray-200"></div>
                                    <span className="text-[12px] font-bold text-gray-500 uppercase">OR</span>
                                    <div className="flex-grow h-[1px] bg-gray-200"></div>
                                </div>
                                ...
                                <button onClick={() => setStep(2)} className="w-full flex items-center border-[1px] border-[#002f34] py-3 px-5 rounded-md font-bold text-[#002f34] bg-white cursor-pointer hover:bg-gray-50 hover:ring-[2px] hover:ring-[#002f34] transition-all">
                                    ...
                                    <span className="flex-grow text-center text-[16px]">Join with Email</span>
                                </button>

                                <button onClick={() => setStep(4)} className="w-full flex items-center border-[1px] border-[#002f34] py-3 px-5 rounded-md font-bold text-[#002f34] bg-white cursor-pointer hover:bg-gray-50 hover:ring-[2px] hover:ring-[#002f34] transition-all">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" className="h-5 w-5"><path fill="currentColor" fillRule="evenodd" d="M18.39 19.98A15.07 15.07 0 0 1 4.02 5.6l3.52-1.4 2.15 4.3-1.67.83v.62a6.03 6.03 0 0 0 6.02 6.02h.62l.28-.56.56-1.1 4.3 2.14-1.41 3.52zm3.13-4.9l-6.02-3.01-1.35.45-.7 1.4a4.02 4.02 0 0 1-3.38-3.37l1.41-.7.45-1.35-3.01-6.02L7.65 2 2.63 4 2 4.95C2 14.34 9.65 22 19.06 22l.93-.63L22 16.35l-.48-1.27z" clipRule="evenodd"></path></svg>
                                    <span className="flex-grow text-center text-[16px]">Join with phone</span>
                                </button>
                            </div>
                        </div>
                    )}
                    ...
                    {step === 2 && (
                        <div className="flex flex-col animate-in slide-in-from-right duration-300">
                            ...
                            <div className="mb-6">
                                ...
                                <input type="email" value={email} onChange={(e) => setEmail(e.target.value)} className="w-full p-4 border border-gray-300 rounded focus:border-[#002f34] outline-none text-lg" placeholder="Email" />
                            </div>
                            <button disabled={!email.includes("@")} onClick={() => setStep(3)} className={`w-full py-4 rounded font-bold text-white text-lg ${email.includes("@") ? 'bg-[#002f34] hover:bg-[#003d45]' : 'bg-gray-300 cursor-not-allowed'}`}>
                                Next
                            </button>
                        </div>
                    )}
                    ...
                    {step === 4 && (
                        <div className="flex flex-col animate-in slide-in-from-right duration-300">
                            ...
                            <button onClick={() => setStep(3)} className="w-full bg-[#002f34] text-white py-4 rounded font-bold text-lg hover:bg-[#003d45]">Next</button>
                        </div>
                    )}
                    ...
                    <div className="mt-6 text-center pb-10">
                        ...
                        <button
                            ...
                            className="text-[#3a77ff] font-bold text-[15px] hover:underline cursor-pointer block w-full text-center"
                        >
